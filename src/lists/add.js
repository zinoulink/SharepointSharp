...
export default async function add(items, options) {
  try {
    if (!this.listID) throw "[SharepointSharp 'add'] the list ID/Name is required.";
    if (!this.url) throw "[SharepointSharp 'add'] not able to find the URL!"; // we cannot determine the url
